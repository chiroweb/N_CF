...
export const ROASTER_SUPREME_MODELS = [
  {
    id: "supreme-3",
    name: "SUPREME 3",
    code: "KBN-SUPREME-3",
    capacity: "3kg",
    target: "Premium Small Roastery",
    targetKr: "프리미엄 소형 로스터리",
    size: "상담 후 안내",
    weight: "상담 후 안내",
    power: "상담 후 안내",
    burner: "Premium Gas Burner",
    controller: "Full Auto / Touchscreen",
    image: `${S3_PRODUCT}/roaster-supreme-3-1.jpg`,
    gallery: [
      `${S3_PRODUCT}/roaster-supreme-3-1.jpg`,
      `${S3_PRODUCT}/roaster-supreme-3-2.jpg`,
      `${S3_PRODUCT}/roaster-supreme-3-3.jpg`,
      `${S3_PRODUCT}/roaster-supreme-3-4.jpg`,
    ],
  },
  {
    id: "supreme-6",
    ...
    burner: "Premium Gas Burner",
    controller: "Full Auto / Touchscreen",
    image: `${S3_PRODUCT}/roaster-supreme-6-1.jpg`,
    gallery: [
      `${S3_PRODUCT}/roaster-supreme-6-1.jpg`,
      `${S3_PRODUCT}/roaster-supreme-6-2.jpg`,
      `${S3_PRODUCT}/roaster-supreme-6-3.jpg`,
      `${S3_PRODUCT}/roaster-supreme-6-4.jpg`,
      `${S3_PRODUCT}/roaster-supreme-6-5.jpg`,
    ],
  },
  {
    id: "supreme-12",
    ...
    code: "KBN-SUPREME-12",
    capacity: "12kg",
    target: "Premium Production",
    targetKr: "프리미엄 생산형 로스터리",
    size: "상담 후 안내",
    weight: "상담 후 안내",
    power: "상담 후 안내",
    burner: "Premium Gas Burner",
    controller: "Full Auto / Touchscreen",
    image: `${S3_PRODUCT}/roaster-supreme-12-1.jpg`,
    gallery: [
      `${S3_PRODUCT}/roaster-supreme-12-1.jpg`,
      `${S3_PRODUCT}/roaster-supreme-12-2.jpg`,
      `${S3_PRODUCT}/roaster-supreme-12-3.jpg`,
      `${S3_PRODUCT}/roaster-supreme-12-4.jpg`,
      `${S3_PRODUCT}/roaster-supreme-12-5.jpg`,
      `${S3_PRODUCT}/roaster-supreme-12-6.jpg`,
    ],
  },
  {
    id: "supreme-18",
    ...
    code: "KBN-SUPREME-18",
    capacity: "18kg",
    target: "Premium Factory",
    targetKr: "프리미엄 대형 생산 현장",
    size: "상담 후 안내",
    weight: "상담 후 안내",
    power: "상담 후 안내",
    burner: "Premium Gas Burner",
    controller: "Full Auto / Touchscreen",
    image: `${S3_PRODUCT}/roaster-supreme-18-1.jpg`,
    gallery: [
      `${S3_PRODUCT}/roaster-supreme-18-1.jpg`,
      `${S3_PRODUCT}/roaster-supreme-18-2.jpg`,
      `${S3_PRODUCT}/roaster-supreme-18-3.jpg`,
      `${S3_PRODUCT}/roaster-supreme-18-4.jpg`,
      `${S3_PRODUCT}/roaster-supreme-18-5.jpg`,
      `${S3_PRODUCT}/roaster-supreme-18-6.jpg`,
    ],
  },
  {
    id: "supreme-24",
    ...
    targetKr: "프리미엄 산업용 로스팅",
    size: "상담 후 안내",
    weight: "상담 후 안내",
    power: "상담 후 안내",
    burner: "Premium Gas Burner",
    controller: "Full Auto / Touchscreen",
    image: `${S3_PRODUCT}/roaster-supreme-24-1.jpg`,
    gallery: [
      `${S3_PRODUCT}/roaster-supreme-24-1.jpg`,
      `${S3_PRODUCT}/roaster-supreme-24-2.jpg`,
      `${S3_PRODUCT}/roaster-supreme-24-3.jpg`,
      `${S3_PRODUCT}/roaster-supreme-24-4.jpg`,
    ],
  },
];

export const ROASTER_SUPREME_IMAGE = ROASTER_SUPREME_MODELS[0].image;
export const ROASTER_SUPREME_GALLERY = ROASTER_SUPREME_MODELS[0].gallery;
