...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "엔비피코리아 NKJC 시리즈의 핵심 사양은 무엇인가요?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "엔비피코리아 NKJC 시리즈는 200℃에서 1,000℃의 직화식 2단 연소 구조로 로스팅 연기 제거율 99.2%를 목표로 설계됩니다. 용량별로 0.5–0.8초의 연소실 체류 시간을 확보해 VOC 분해 안정성을 유지합니다.",
      },
    },
    {
      "@type": "Question",
