...
export const metadata: Metadata = {
  title: "넛츠스타 NUTS-STAR 넛버터머신 — 50kg 상업용 견과 분쇄기",
  description:
    "엔비피코리아가 자체 설계·제작한 50kg급 상업용 넛버터머신 넛츠스타 NUTS-STAR. 땅콩·아몬드·캐슈넛·피스타치오를 연속 분쇄해 견과류 버터, 정과, 베이커리 토핑·필링으로 가공합니다. 견과류 제조·가공, 백화점 팝업, 방앗간, 카페, 베이커리 다섯 업태에서 2025–2026년 11개 거래처 24대 납품.",
  alternates: { canonical: "/the-lab" },
  openGraph: {
    title: "넛츠스타 NUTS-STAR 넛버터머신 — 50kg 상업용 견과 분쇄기 | 엔비피코리아",
    description:
      "자체 설계 50kg급 넛버터머신. 땅콩·아몬드·캐슈넛·피스타치오 연속 분쇄. 2025–2026 11개 거래처 24대 납품.",
...
const productJsonLd = {
  ...
  alternateName: ["NUTS-STAR", "Nut Butter Machine", "넛버터머신"],
  category: "Commercial Food Processing Equipment",
  description:
    "엔비피코리아가 설계·제작하는 50kg급 상업용 넛버터머신. 견과류를 연속 분쇄해 버터·정과·토핑·필링으로 가공하는 라인. 즉석 시연과 대량 생산 모두 대응.",
