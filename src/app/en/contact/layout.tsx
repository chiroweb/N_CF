...
export const metadata: Metadata = {
  ...
  description:
    "Quotes, installation consulting, and after-sales service for the NKJC afterburner and NUTS-STAR nut butter machine. Headquarters and factory in Ansan, Gyeonggi-do, South Korea. TEL +82-31-434-6566 · nbpkorea@nbpkorea.co.kr",
  alternates: {
