...
export const metadata: Metadata = {
  ...
  description:
    "The NK direct-flame afterburner series from NBPKOREA. Public lineup from 5Kg to 60Kg, with 120Kg industrial builds handled by site consultation. 200–1,000°C combustion, 99.2% smoke removal, 30%+ gas savings, 40:1 proportional control, 98% thermal efficiency. Gas Safety Corporation certified.",
  alternates: {
    canonical: "/en/afterburner",
    languages: { "ko-KR": "/afterburner", en: "/en/afterburner" },
  },
  openGraph: {
    title: "Afterburner — NBPKOREA NK Series",
    description:
