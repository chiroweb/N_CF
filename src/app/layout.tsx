...
const SITE_DESCRIPTION =
  "엔비피코리아는 2006년부터 직접화염 애프터버너만 만들어온 커피 로스터 후연 제거장치 전문 제조사입니다. 로스팅에서 발생하는 연기·냄새·유해물질을 200℃–1,000℃ 고온 연소로 99.2% 제거하고, 경쟁 제품 대비 가스를 30% 이상 절감합니다. 5Kg 소형 로스터부터 120Kg 산업용 대형까지 NKJC 라인업. 2024–2025 국내 16개 광역과 해외 7개국에 총 379건 납품. 경기도 안산 본사·공장에서 설계·제작·설치·A/S 일괄 대응.";
